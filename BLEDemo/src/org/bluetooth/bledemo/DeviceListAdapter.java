...
public class DeviceListAdapter extends BaseAdapter {
	...
	private ArrayList<BluetoothDevice> mDevices;  //动态数组
	private ArrayList<byte[]> mRecords;	//动态数组
	private ArrayList<Integer> mRSSIs;	//动态数组
	
	private LayoutInflater mInflater;	//用来加载布局(动态的加载)
